...
TARGET := my_cpp_addon
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=my_cpp_addon' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(builddir)/my_cpp_addon.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/my_cpp_addon.node: LIBS := $(LIBS)
$(builddir)/my_cpp_addon.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/my_cpp_addon.node: TOOLSET := $(TOOLSET)
$(builddir)/my_cpp_addon.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/my_cpp_addon.node
# Add target alias
.PHONY: my_cpp_addon
my_cpp_addon: $(builddir)/my_cpp_addon.node

# Short alias for building this executable.
.PHONY: my_cpp_addon.node
my_cpp_addon.node: $(builddir)/my_cpp_addon.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/my_cpp_addon.node
